...
class CTableBase {
  ...
  async delete() {
    ...
    await PGSQL.Delete(this.connection, this.table, Si(this.record, ...H(this.updateID)));
    return this;
  }
  /**
  ...
  async loadID(id, ignoreCustomerCheck = false) {
    ...
    const record = await PGSQL.GetByID((_a = this.readerConnection) != null ? _a : this.connection, this.table, f(id));
    if (!record) {
  ...
  async loadValues(values, options) {
    ...
    if (options == null ? void 0 : options.sortPrimary) {
      sort += ` ORDER BY ${PGSQL.CleanSQL(options.sortPrimary)} ${((_a = options == null ? void 0 : options.ascendingPrimary) != null ? _a : true) ? "ASC" : "DESC"}`;
      if (options == null ? void 0 : options.sortSecondary) {
        sort += `, ${PGSQL.CleanSQL(options == null ? void 0 : options.sortSecondary)} ${((_b = options == null ? void 0 : options.ascendingSecondary) != null ? _b : true) ? "ASC" : "DESC"}`;
      }
    }
  ...
  async listRecordsByIDs(ids) {
    ...
    const sql = `SELECT *
		             FROM ${this.table}
		             WHERE id = ANY ($1::INT[]) `;
    return await PGSQL.FetchMany((_a = this.readerConnection) != null ? _a : this.connection, sql, [ids]);
  }
  /**
  ...
  async listRecordsByValues(whereValues, options) {
    ...
    if (options == null ? void 0 : options.sortPrimary) {
      sql += ` ORDER BY ${PGSQL.CleanSQL(options == null ? void 0 : options.sortPrimary)} ${((_a = options == null ? void 0 : options.ascendingPrimary) != null ? _a : true) ? "ASC" : "DESC"}`;
      if (options == null ? void 0 : options.sortSecondary) {
        sql += `, ${PGSQL.CleanSQL(options == null ? void 0 : options.sortSecondary)} ${((_b = options == null ? void 0 : options.ascendingSecondary) != null ? _b : true) ? "ASC" : "DESC"}`;
      }
    }
    return await PGSQL.FetchMany((_c = this.readerConnection) != null ? _c : this.connection, sql, params.values);
  }
  /**
  ...
  async listIDsByValues(whereValues, sortPrimary, ascendingPrimary = true, sortSecondary, ascendingSecondary = true) {
    ...
    return await PGSQL.FetchArray((_a = this.readerConnection) != null ? _a : this.connection, sql, params.values);
  }
  /**
  ...
  async getRecordByValues(whereValues, options) {
    ...
    return PGSQL.FetchOne((_c = this.readerConnection) != null ? _c : this.connection, sql, params.values);
  }
  /**
  ...
  async getRecordByID(id) {
    ...
    const sql = `SELECT *
		             FROM ${this.table}
		             WHERE id = $1`;
    const one = await PGSQL.FetchOne((_a = this.readerConnection) != null ? _a : this.connection, sql, [id]);
...
export {
  ...
  PGView,
  PGWhereSearchClause,
  PaginatorApplyRowCount,
  PaginatorInitializeResponseFromRequest,
  PaginatorResponseFromRequestCount,
  PaginatorReturnRowCount,
  TS_EOL,
  initialFixedWidthMapOptions
};
